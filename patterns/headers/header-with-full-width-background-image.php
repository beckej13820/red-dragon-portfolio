 ...
 */
?>
<!-- wp:group {"metadata":{"categories":["header"],"patternName":"core/header-inside-full-width-background-image","name":"Header with full-width background image"},"align":"full","layout":{"type":"constrained"}} -->
