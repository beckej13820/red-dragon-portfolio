 ...
 * Slug: red-dragon-portfolio/overlapped-images
	...
	<div class="wp-block-columns alignwide">
		...
		<div class="wp-block-column is-vertically-aligned-center" style="padding-right:0;padding-left:0;flex-basis:50%">
			...
			<div class="wp-block-group">
				...
				<h2 class="wp-block-heading is-style-text-annotation"><?php esc_html_e( 'About Us', 'red-dragon-portfolio' ); ?></h2>
				<!-- /wp:heading -->
			</div>
			<!-- /wp:group -->
			...
			<?php
				printf(
					...
					esc_html__( '%s is a flower delivery and subscription business. Based in the EU, our mission is not only to deliver stunning flower arrangements across but also foster knowledge and enthusiasm on the beautiful gift of nature: flowers.', 'red-dragon-portfolio' ),
					'<strong>' . esc_html_x( 'Fleurs', 'Example brand name.', 'red-dragon-portfolio' ) . '</strong>'
				);
				?>
			</p>
			<!-- /wp:paragraph -->
