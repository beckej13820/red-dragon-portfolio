 ...
 */
?>
<!-- wp:group {"metadata":{"categories":["featured"],"patternName":"red-dragon-portfolio/overlapped-images","name":"Overlapping images and paragraph on right"},"align":"full","className":"is-style-section-2","style":{"spacing":{"padding":{"top":"var:preset|spacing|80","bottom":"var:preset|spacing|80"},"margin":{"top":"0","bottom":"0"}}},"layout":{"type":"constrained"}} -->
